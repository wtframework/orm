 ...
 * @method Query havingRaw(string $condition, string|int|float|array $bindings = [])
 * @method Query orHavingRaw(string $condition, string|int|float|array $bindings = [])
 * @method Query havingNotRaw(string $condition, string|int|float|array $bindings = [])
 * @method Query orHavingNotRaw(string $condition, string|int|float|array $bindings = [])
 ...
 * @method Query whereRaw(string $condition, string|int|float|array $bindings = [])
 * @method Query orWhereRaw(string $condition, string|int|float|array $bindings = [])
 * @method Query whereNotRaw(string $condition, string|int|float|array $bindings = [])
 * @method Query orWhereNotRaw(string $condition, string|int|float|array $bindings = [])
